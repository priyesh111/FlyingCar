...
class CartModelScreen extends StatefulWidget {
  int indexes;
  final String carCompany;
  CartModelScreen({required this.carCompany,required this.indexes});

  @override
  State<CartModelScreen> createState() => _CartModelScreenState();
}

class _CartModelScreenState extends State<CartModelScreen> {
                ...
                builder: (BuildContext context,
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      carDetailController.descriptions = carModels[index]['descriptions'].toString();
                      ...
                      carDetailController.images = carModels[index]['images'].toString();
                          ...
                          Padding(
                            ...
                            child: Card(
                              child: Container(
                                  ...
                                  child: Image.network(carModels[index]['images'].toString())),
                            ),
                          ),
                          Text(
                            ...
                            child: Card(
                              child: ExpandablePanel(
                                ...
                                expanded: Padding(
                                  ...
                                  child: Text(
                                    carModels[index]['descriptions'].toString(),
                                    softWrap: true,
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: ConstFont.popinsRegular),
